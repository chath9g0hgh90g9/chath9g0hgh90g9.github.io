...
function oSendpulsePush() {
    var L = "https://chath9g0hgh90g9.github.io";
    var j = "https://chath9g0hgh90g9.github.io";
    var p = "https://chath9g0hgh90g9.github.io";
    var k = "https://chath9g0hgh90g9.github.io";
    var q = "8e7162461417bee0a21462729d592df4";
    var l = false;
    var w = false;
    var A = {};
    var a = "";
    ...
    var s = true;
    var i = "765f8243a35655c44bc1382efa285219";
    var z = "";
    var m = "";
    var e = "";
    var E = "Ð Ð°Ð·Ñ€ÐµÑˆÐ¸Ñ‚Ðµ ÑÐ°Ð¹Ñ‚Ñƒ chath9g0hgh90g9.github.io Ð¾Ñ‚Ð¿Ñ€Ð°Ð²Ð»ÑÑ‚ÑŒ Ð²Ð°Ð¼ ÑƒÐ²ÐµÐ´Ð¾Ð¼Ð»ÐµÐ½Ð¸Ñ Ð½Ð° Ñ€Ð°Ð±Ð¾Ñ‡Ð¸Ð¹ ÑÑ‚Ð¾Ð»";
    var B = null;
    var r = null;
    var H = false;
    var t = {};
    ...
    var I = true;
    var d = "1";
    var D = "https://sendpulse.com/ru/webpush-powered-by-sendpulse?from=6928100";
    var G = {
        ...
        if (l) {
            if (s) {
                oSpP.startDelayedSubscription(function () {
                    ...
                    if (a == "safari" || a == "chrome" || a == "firefox" || a == "opera") {
    ...
    this.detectSite = function () {
        var M = (!(oSpP.clearDomain(window.location.href.toLowerCase()).indexOf(oSpP.clearDomain(L.toLowerCase())) === -1));
        if (!M) {
            M = (!(oSpP.clearDomain(window.location.href.toLowerCase()).indexOf(oSpP.clearDomain(j.toLowerCase())) === -1))
        }
        return M
    };
    this.detectOrigin = function (M) {
        return (!(oSpP.clearDomain(M.toLowerCase()).indexOf(oSpP.clearDomain(p.toLowerCase())) === -1))
    };
    ...
    this.detectBrowser = function () {
        var O, N = navigator.userAgent,
            M = N.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i) || [];
        ...
        return /trident/i.test(M[1]) ? (O = /\brv[ :]+(\d+)/g.exec(N) || [], {
            name: "IE",
            version: O[1] || ""
        }) : "Chrome" === M[1] && (O = N.match(/\bOPR\/(\d+)/), null != O) ? {
            name: "Opera",
            version: O[1]
        } : (M = M[2] ? [M[1], M[2]] : [navigator.appName, navigator.appVersion, "-?"], null != (O = N.match(/version\/(\d+)/i)) && M.splice(1, 1, O[1]), {
            name: M[0],
            version: M[1]
        })
    };
    ...
    this.checkSafariPermission = function (M) {
        ...
        if (M.permission === "default") {
            ...
            window.safari.pushNotification.requestPermission(n, K, {
                appkey: i
            ...
            case "opera":
                navigator.serviceWorker.ready.then(function (O) {
                    O.pushManager.subscribe({
                        ...
                        var S = P ? btoa(String.fromCharCode.apply(null, new Uint8Array(P))) : "";
                        var R = U.getKey ? U.getKey("auth") : "";
                        var T = R ? btoa(String.fromCharCode.apply(null, new Uint8Array(R))) : "";
    ...
    this.showhelpPromptText = function () {
        if (E.length >= 0) {
            ...
            O.rel = "stylesheet";
            O.type = "text/css";
            O.href = "https://cdn.sendpulse.com/dist/css/push/sendpulse-prompt.min.css";
            O.media = "all";
            P.appendChild(O);
            if (E == "-") {
                return
            ...
            N.innerHTML += "<big>Ã—</big><br><small>ESC</small>";
            N.setAttribute("onclick", "oSpP.closePromptHelpText(false); return false;");
            Q.appendChild(N);
    ...
    this.showCustomPrompt = function () {
        ...
        Q.rel = "stylesheet";
        Q.type = "text/css";
        Q.href = "https://cdn.sendpulse.com/dist/css/push/sendpulse-prompt.min.css";
        Q.media = "all";
        T.appendChild(Q);
        var ab;
        ...
        if (z.length > 0) {
            ...
            af.setAttribute("src", "https://cdn.sendpulse.com/img/push/icon-ring.svg");
            if (U) {
                var Z = document.createElement("span");
                Z.setAttribute("class", "sp-link-wrapper");
                var ac = document.createElement("a");
                ac.setAttribute("class", "sp-link");
                ac.setAttribute("href", D);
            ...
            if (X == "sendpulse-bar") {
                ...
                W.setAttribute("class", "sendpulse-prompt-info sendpulse-prompt-message-text");
                W.setAttribute("style", "color: " + ab.textcolor + " !important;");
                W.innerHTML += e;
                var Y = document.createElement("span");
                ag.innerHTML += P + '<svg viewBox="0 0 525.153 525.153" width="40" height="40" xmlns:xlink="http://www.w3.org/1999/xlink" class="sendpulse-bell-icon"><use class="sendpulse-bell-path" style="fill: ' + ab.textcolor + ' !important;" xlink:href="#sp_bell_icon" x="0" y="0" />  </svg>'
            } else {
                if (X == "sendpulse-fab") {
                    var W = document.createElement("div");
                    W.setAttribute("class", "sendpulse-prompt-title sendpulse-prompt-message-text");
                    if (ab.textcolor.length > 0) {
                        W.setAttribute("style", "color: " + ab.textcolor + " !important;")
                    }
                    W.innerHTML = m;
                    var Y = document.createElement("div");
                    Y.setAttribute("class", "sendpulse-prompt-info sendpulse-prompt-message-text");
                    if (ab.textcolor.length > 0) {
                    ...
                    if (ab.btncolor.length > 0) {
                        ae.setAttribute("style", "background-color: " + ab.btncolor + " !important;")
                    }
                    ae.innerHTML += P + '<svg viewBox="0 0 525.153 525.153" width="40" height="40" xmlns:xlink="http://www.w3.org/1999/xlink" class="sendpulse-bell-icon" ><use class="sendpulse-bell-path bell-prompt-fab" style="fill: ' + ab.iconcolor + ' !important;" xlink:href="#sp_bell_icon" x="0" y="0" /></svg>'
                }
            }
            if (X == "sendpulse-bar") {
                var M = document.createElement("div");
                ...
                ah.setAttribute("class", "sendpulse-prompt-btn sendpulse-accept-btn sp_notify_prompt");
                ah.setAttribute("type", "button");
                ah.setAttribute("onclick", "oSpP.startSubscription();oSpP.closeCustomPrompt(false); return false;");
                var O = document.createElement("button");
                O.setAttribute("class", "sendpulse-prompt-btn sendpulse-disallow-btn");
                O.setAttribute("type", "button");
                O.setAttribute("onclick", "oSpP.sendPromptStat('prompt_denied');oSpP.closeCustomPrompt(true); return false;");
                ah.innerHTML = ab.allowbtntext;
                O.innerHTML = ab.disallowbtntext;
                ah.setAttribute("style", "background-color:" + ab.buttoncolor + " !important;border-color:" + ab.buttoncolor + " !important;");
            ...
            if (X == "sendpulse-bar") {
                ...
                N.setAttribute("onclick", "oSpP.closeCustomPrompt(false); return false;");
